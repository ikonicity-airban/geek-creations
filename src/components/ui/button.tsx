...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "dark:bg-accent bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm hover:shadow-md active:scale-[0.98]",
        destructive:
        ...
        outline:
          "border-[1px] border-primary/30 bg-background text-primary shadow-xs hover:bg-accent/10 hover:border-accent/50 dark:bg-input/30 dark:border-secondary/50 dark:text-foreground dark:hover:bg-accent/10 dark:hover:border-accent/50 active:scale-[0.98]",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-sm hover:shadow-md active:scale-[0.98]",
        ghost:
          "text-primary hover:bg-primary/10 hover:text-primary dark:text-secondary dark:hover:bg-secondary/20 active:scale-[0.98]",
        link: "text-primary underline-offset-4 hover:underline hover:text-primary/80 dark:text-secondary dark:hover:text-secondary/80",
        accent:
          "bg-[#e2ae3d] text-primary hover:bg-[#e2ae3d]/90 shadow-sm hover:shadow-md active:scale-[0.98] font-bold",
      },
      size: {
