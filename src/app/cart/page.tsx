...
import { Trash2, Plus, Minus, ShoppingBag, ArrowRight, ShoppingCart as CartIcon } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
              Looks like you haven't added any items to your cart yet. Start shopping to find your perfect geek gear!
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              >
                  ...
                  {cart.subtotal < 50000 && cart.subtotal > 0 && (
                    <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                      <p className="text-xs text-yellow-800 dark:text-yellow-200">
                        Add ₦{(50000 - cart.subtotal).toLocaleString()} more to get FREE shipping!
                      </p>
                    </div>
                  )}
                ...
                <Link href="/checkout">
                  <Button size="lg" className="w-full bg-indigo-600 hover:bg-indigo-700 h-14 text-lg">
                    Proceed to Checkout
